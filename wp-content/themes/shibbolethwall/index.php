...
<div id="main-content" class="homepage index">
	<!-- Hero Banner Section -->
	<?php if(get_field('show_hero_banner', 'option')) {
		$hero_banner_category = get_field('hero_banner_category', 'option');
		$hero_banner_class = get_field('hero_banner_class', 'option');
		$hero_banner_id = get_field('hero_banner_id', 'option');
		$show_navigation_arrow = get_field('show_navigation_arrow', 'option');
		$show_navigation_dot = get_field('show_navigation_dot', 'option');
		$items_to_display = get_field('items_to_display', 'option');
		$carousel_items_visible_desktop = get_field('carousel_items_visible_desktop', 'option');
		$carousel_items_visible_tablet = get_field('carousel_items_visible_tablet', 'option');
		$carousel_items_visible_mobile = get_field('carousel_items_visible_mobile', 'option');
	?>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						...
						?>
						<?php if ($slider) : $i = 1; ?>
							<div class="owl-carousel<?php echo ($show_navigation_arrow ? ' has-nav-visible' : ''); ?><?php echo ($show_navigation_dot ? ' has-dots-visible' : ''); ?><?php echo ' ' . $hero_banner_class; ?>" id="<?php echo $hero_banner_id; ?>">
							...
							<script>
								$(document).ready(function(){
									$('.owl-carousel#<?php echo $hero_banner_id; ?>').owlCarousel({loop:true,margin:0,nav:<?php echo ($show_navigation_arrow ? 'true' : 'false'); ?>,dots:<?php echo ($show_navigation_dot ? 'true' : 'false'); ?>,autoplay:true,autoplayTimeout:8000,autoplayHoverPause:true,animateOut: 'fadeOut',animateIn: 'fadeIn',responsive:{0:{items:<?php echo $carousel_items_visible_mobile; ?>},600:{items:<?php echo $carousel_items_visible_tablet; ?>},1000:{items:<?php echo $carousel_items_visible_desktop; ?>}}});
								});											
							</script>
						<?php else : endif; ?>
					</div>
	...
	<?php if( have_rows('section_item', 'option' ) ): $z_index = 50; ?>
